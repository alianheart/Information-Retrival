...
# GUI build steps
window = Tk()
window.configure(bg='#288fef')
window.geometry('1000x750')
label = Label(window, text="prssearch", bg="#044b8e", fg="white", font="'Arial' 24 bold")
...
search = Button(window, text='SEARCH', bg="#abafb2", fg="#162e44", font="'Arial' 10", command=pub_qp_data).place(x=370, y=70)
operator = IntVar()
operator.set(2)
